...
#### Goal
exploration of senors & max code useage & useful functions

#### Design process
exploration of the microbit of what sensors and what input can be used with current knowlege.
I orginally set out to have a dirvers multitool. Hence why the compass function.
I wanted a velocity function but finding a timer and a timer reset and where position zero would require extra testing
The magnetic strength was interesting to me personally. 
The selection menu operates on a and/or b inputs a increments a selection b decrements. a and b sets to zero in the event of a large menu.
The way this prgram is stuctured many functions can be added on without much interface changes.
I am disatisfyed with the display though. 
#### JS Constructs & objects
four functions where made compass (), mag_str text_selection_menu and selection_menu().
